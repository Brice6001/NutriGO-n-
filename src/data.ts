...
export const MEALS_CATALOG: Meal[] = [
  ...
  },
  {
    ...
    },
    {
      ...
      category: 'Breakfast',
      dietTags: ['Vegan', 'Gluten Free', 'Low Sugar'],
      price: 8.5,
      rating: 4.7,
      reviewsCount: 70,
      prepTime: 7,
      calories: 260,
      macros: { protein: 6, carbs: 35, fat: 9 },
      image: 'https://example.com/acai_bowl.jpg',
      description: 'Frozen acai blend topped with granola, banana slices, coconut flakes, and fresh berries.',
      highlightTags: ['ANTIOXIDANT RICH', 'ENERGY BOOST']
    },
    {
      id: 'protein_oats',
      ...
      prepTime: 5,
      calories: 320,
      macros: { protein: 20, carbs: 45, fat: 6 },
      image: 'https://example.com/protein_oats.jpg',
      description: 'Creamy oatmeal stirred with whey protein, topped with almonds and honey.',
      highlightTags: ['HIGH PROTEIN', 'FILLING']
    },
    {
      id: 'veggie_frittata',
      name: 'Savory Veggie Frittata',
      category: 'Breakfast',
      ...
      image: 'https://example.com/veggie_frittata.jpg',
      description: 'Egg frittata baked with spinach, tomatoes, bell peppers, and feta cheese.',
      highlightTags: ['BRUNCH FAVORITE', 'GUT FRIENDLY']
    },
    {
      id: 'quinoa_salad',
